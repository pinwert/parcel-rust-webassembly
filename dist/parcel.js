...
function recalc(all, num) {
  ...
  for (let j = 1; j <= all - num + 1; j++) {
    const a = (0, _add.calculate_probability)(num, all, j);
...
},{"./add.rs":3}],4:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '32933' + '/');
...
var b=require(6);b.register("wasm",require(8));b.load([["2967d2bd22479059c355a96b4df697d0.wasm",3],2]);
},{}]},{},[4,0])
